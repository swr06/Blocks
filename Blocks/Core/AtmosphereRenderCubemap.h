...
namespace Blocks
{
	class AtmosphereRenderMap
	{
	public :

		AtmosphereRenderMap(GLuint res);

		AtmosphereRenderMap(const AtmosphereRenderMap&) = delete;
		AtmosphereRenderMap operator=(AtmosphereRenderMap const&) = delete;

		AtmosphereRenderMap(AtmosphereRenderMap&& v)
		{
			m_FBO = v.m_FBO;
